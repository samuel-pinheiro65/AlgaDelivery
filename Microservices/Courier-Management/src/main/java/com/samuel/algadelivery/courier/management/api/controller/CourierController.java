package com.samuel.algadelivery.courier.management.api.controller;

import com.samuel.algadelivery.courier.management.api.model.CourierInput;
import com.samuel.algadelivery.courier.management.api.model.CourierPayoutCalculationInput;
import com.samuel.algadelivery.courier.management.api.model.CourierPayoutResultModel;
import com.samuel.algadelivery.courier.management.domain.model.Courier;
import com.samuel.algadelivery.courier.management.domain.repository.CourierRepository;
import com.samuel.algadelivery.courier.management.domain.service.CourierPayoutService;
import com.samuel.algadelivery.courier.management.domain.service.CourierRegistrationService;
...
public class CourierController {
    ...
    public CourierPayoutResultModel calculate(@RequestBody CourierPayoutCalculationInput input){
        ...
        //codigo para forçar falhas e testar a resiliencia
        if(Math.random() < 0.5){
