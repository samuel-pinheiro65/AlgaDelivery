package com.samuel.algadelivery.delivery.tracking.api.controller;

import com.samuel.algadelivery.delivery.tracking.api.model.CourierIdInput;
...
import com.samuel.algadelivery.delivery.tracking.domain.service.DeliveryCheckpointService;
import com.samuel.algadelivery.delivery.tracking.domain.service.DeliveryPreparationService;
...
public class DeliveryController {
    ...
    public PagedModel<Delivery> findAll(@PageableDefault Pageable pageable){
        //codigo para induzir erros e testar resiliencia
        if(Math.random() < 0.7){
